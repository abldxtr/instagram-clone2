        ...
        return (
          ...
          >
            <Link
              ...
              className="font-semibold text-[rgb(245,245,245)]"
            >
              {username}
            </Link>
            <p className="text-[rgb(245,245,245)]">{comment.body}</p>
          </div>
        );
      })}
      <Form {...form}>
        <form
          ...
          className="border-b  border-neutral-800 pb-3 py-1 flex items-center space-x-2"
        >
          <FormField
              ...
              <FormItem className="w-full flex">
                <FormControl>
                  <input
                    ...
                    className="bg-transparent text-sm border-none focus:outline-none flex-1  text-white placeholder-neutral-400 font-medium"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
