  ...
  return (
    <Form {...form}>
      <form
        ...
        className={cn(
          " relative  dark:border-neutral-800 py-3 flex items-center space-x-2 w-full px-3",
          className
        )}
      >
        {isSubmitting && (
              ...
              <FormItem className="w-full flex">
                <FormControl>
                  <input
                    ...
                    className="bg-transparent text-sm border-none focus:outline-none flex-1 text-neutral-400 placeholder-neutral-400 font-medium disabled:opacity-30"
                    {...field}
                  />
                </FormControl>
                <FormMessage />
